--- Load Config, will be available in any other server scripts.
require "MyModName/Config";

--- Load Utils, will be available in any other server scripts.
...
function MyModNameServer.SendCommand(command, data, player)
